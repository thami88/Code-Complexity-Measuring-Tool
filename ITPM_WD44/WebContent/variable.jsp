...
<title>Variable Complexity</title>
	...
	<nav
		...
		<div class="collapse navbar-collapse" id="basicExampleNav">
			...
			<ul class="navbar-nav mr-auto">
				...
				<li class="nav-item active"><a class="nav-link" href="#">Variable<span class="sr-only">(current)</span></a></li>
				<li class="nav-item"><a class="nav-link" href="WeightVariable.jsp">Change Variable Weight</a></li>
			</ul>
			<!-- Links -->
		</div>
		<!-- Collapsible content -->
